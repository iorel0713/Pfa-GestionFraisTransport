...
public class AcceptedRequestAdapter extends BaseAdapter {
    ...
    public AcceptedRequestAdapter(Activity activity, List<Request> objects) {
    ...
    public AcceptedRequestAdapter(MainActivity activity) {
    ...
    public View getView(int request, View convertView, ViewGroup parent) {
        if(convertView == null)
            convertView = inflater.inflate(R.layout.item_acceptedrequest, null);
