...
public class RefusedRequestAdapter extends BaseAdapter {
    private List<Request> objects;
    private LayoutInflater inflater;

    public RefusedRequestAdapter(Activity activity, List<Request> objects) {
    ...
    public RefusedRequestAdapter(MainActivity activity) {
    ...
    public View getView(int request, View convertView, ViewGroup parent) {
        if(convertView == null)
            convertView = inflater.inflate(R.layout.item_refused_request, null);
