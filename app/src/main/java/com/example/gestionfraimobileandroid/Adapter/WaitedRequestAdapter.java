...
public class WaitedRequestAdapter  extends BaseAdapter {
    private List<Request> objects;
    private LayoutInflater inflater;

    public WaitedRequestAdapter(Activity activity, List<Request> objects) {
    ...
    public WaitedRequestAdapter(MainActivity activity) {
    ...
    public View getView(int request, View convertView, ViewGroup parent) {
        if(convertView == null)
            convertView = inflater.inflate(R.layout.item_waitedrequest, null);
